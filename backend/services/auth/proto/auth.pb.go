...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x06avatar\x18\x05 \x01(\tR\x06avatar\"\xea\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	...
	"\n" +
	"updated_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\x95\x01\n" +
	"\vAuthService\x12D\n" +
	"\vVerifyToken\x12\x18.auth.VerifyTokenRequest\x1a\x19.auth.VerifyTokenResponse\"\x00\x12@\n" +
	"\vGetUserByID\x12\x18.auth.GetUserByIDRequest\x1a\x15.auth.GetUserResponse\"\x00B\x1dZ\x1bbackend/services/auth/protob\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	0, // 2: auth.AuthService.VerifyToken:input_type -> auth.VerifyTokenRequest
	2, // 3: auth.AuthService.GetUserByID:input_type -> auth.GetUserByIDRequest
	1, // 4: auth.AuthService.VerifyToken:output_type -> auth.VerifyTokenResponse
	3, // 5: auth.AuthService.GetUserByID:output_type -> auth.GetUserResponse
