...
func (c *commentServiceClient) GetCommentsByTopic(ctx context.Context, in *GetCommentsByTopicRequest, opts ...grpc.CallOption) (*GetCommentsByTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentService_GetCommentsByTopic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentServiceClient) LikeComment(ctx context.Context, in *LikeCommentRequest, opts ...grpc.CallOption) (*LikeCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentService_LikeComment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
